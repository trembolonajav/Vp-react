...
export function HuntRoutePage(){
  ...
  return <main className="vplab-react"><div className="container">
    <nav className="vplab-react__tools"><Link to="/vplab/">Avaliar IV</Link><Link to="/vplab/pokedex">Pokédex</Link><Link to="/vplab/pokefipe">PokeFipe</Link><Link className="is-active" to="/vplab/rota">Rota de caça</Link><Link to="/vplab/breeding">Breeding</Link><Link to="/vplab/clas">Clãs</Link><a href="/vplab/legacy/?tab=profissoes">Profissões</a></nav>
