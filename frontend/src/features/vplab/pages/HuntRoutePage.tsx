...
export function HuntRoutePage(){
  ...
  return <main className="vplab-react"><div className="container">
    <header className="vplab-react__hero route-v3__hero"><div><span className="vplab-react__eyebrow">Rota de caça</span><h1>Peguei esse Pokémon — para onde eu vou?</h1><p>Diga quem você usa e em que nível está. O VPLab desenha a rota faixa por faixa: <b>o melhor alvo, as alternativas, as hunts seguras</b> e o que é perda de tempo.</p></div><span className="vplab-react__privacy">Mapa conferido em 17/07/2026</span></header>
